...
export type IncrementInstruction<
  TProgram extends string = typeof ANCHOR_COUNTER_PROGRAM_ADDRESS,
...
export function getIncrementInstruction<
  TAccountCounter extends string,
  TAccountAuthority extends string,
  TProgramAddress extends Address = typeof ANCHOR_COUNTER_PROGRAM_ADDRESS,
>(
  ...
  const programAddress =
    config?.programAddress ?? ANCHOR_COUNTER_PROGRAM_ADDRESS;
